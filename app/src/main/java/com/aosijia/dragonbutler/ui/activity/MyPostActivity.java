...
import com.aosijia.dragonbutler.ui.fragment.MyForumPostFragment;
import com.aosijia.dragonbutler.ui.fragment.MySecondhandPostFragment;
...
public class MyPostActivity extends BaseActivity{
    ...
    private void initView() {
        setTitle(getString(R.string.my_post), null, NO_RES_ID);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    return Fragment.instantiate(MyPostActivity.this,
                            MyForumPostFragment.class.getName(), null);
                case 1:
                    return Fragment.instantiate(MyPostActivity.this,
                            MySecondhandPostFragment.class.getName(), null);
            }
            return new Fragment();
        }
