...
import com.aosijia.dragonbutler.ui.fragment.MyForumFavoriteFragment;
import com.aosijia.dragonbutler.ui.fragment.MySecondhandFavoriteFragment;
...
public class MyFavoriteActivity extends BaseActivity{
    ...
    private void initView() {
        setTitle(getString(R.string.my_favorite), null, NO_RES_ID);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    return Fragment.instantiate(MyFavoriteActivity.this,
                            MyForumFavoriteFragment.class.getName(), null);
                case 1:
                    return Fragment.instantiate(MyFavoriteActivity.this,
                            MySecondhandFavoriteFragment.class.getName(), null);
            }
            return new Fragment();
        }
