package com.aosijia.dragonbutler.imagegroup.utils;
...
public class ImageUtils {
    ...
    public static Bitmap imageZoom(Context context, Bitmap bitMap) {
        ...
        //获取屏的宽度和高度
        int screenWidth = com.aosijia.dragonbutler.imagegroup.utils.DisplayUtils.getScreenWidth(context);
        int screenHeight = com.aosijia.dragonbutler.imagegroup.utils.DisplayUtils.getScreenHeight(context);
