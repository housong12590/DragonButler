package com.aosijia.dragonbutler.imagegroup.photodraweeview;
...
public interface IAttacher {
    ...
    void setOnScaleChangeListener(com.aosijia.dragonbutler.imagegroup.photodraweeview.OnScaleChangeListener listener);
